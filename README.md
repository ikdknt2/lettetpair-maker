...
### 手順
1. Supabase プロジェクト作成
2. Authentication で GitHub プロバイダを有効化（おすすめ）
2.5. 代替として Email OTP でもログイン可能
...
5. GitHub provider（または Email OTP）を有効化
...
### 無料運用おすすめ
- まずは **GitHubログイン** または **Email OTP** を使うと、決済なしでも始めやすいです。


- 画面上の「メールでログイン」ボタンからOTPメールログインが可能です。
